...
- Separate student Vocabulary guide progressing from one-syllable to four-syllable words with stress, clap-and-say practice, and female audio
...
```json
{"status":"ok","service":"mana-english-api","version":"0.8.0"}
```
