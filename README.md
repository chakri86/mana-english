...
- Slow Telugu pronunciation, natural connected pronunciation, and child-friendly Telugu meaning for every key phrase
...
```json
{"status":"ok","service":"mana-english-api","version":"0.5.5"}
```
